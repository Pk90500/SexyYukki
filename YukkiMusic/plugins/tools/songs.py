...
async def song_commad_private(client, message: Message, _):
    ...
    if app.username != "YukkixPersonalBot":
        return await message.reply_text("Song Module is currently disabled on Public bots due to copyright issues, Please use @YukkixPersonalBot")
